...
namespace FlooringProgram.UI.Workflows
{
    class AddOrderWorkflow
    {
        ...
        private UserInputRequest RequestUserForInfo()
        {
            ...
            //Allows any case product type, then converts to it UpperFirst format
            request.RequestOrder.ProductType = GetProductType();
            var producttype = request.RequestOrder.ProductType;
            producttype = UpperFirst(producttype);
            request.RequestOrder.ProductType = producttype;
        ...
        private decimal GetFloorArea()
        {
            ...
            return UserInteractions.GetFloorArea("Enter the total Area of the Floor in square feet: ");
        ...
        private string GetProductType()
        {
            ...
            return UserInteractions.GetProductType("Enter the Product Type: ");
        }
