...
namespace FlooringProgram.UI.Utilties
{
    public class DetailsPrinter
    {
        ...
        public static void PrintOrdersSpecificDate(DateTime date)
        {
            ...
            Console.WriteLine("Orders from {0}:", date);
        ...
        public static void PrintProductsList(List<ProductInformation> listOfProducts)
        {
            var productList = listOfProducts.OrderBy(p => p.ProductType);
