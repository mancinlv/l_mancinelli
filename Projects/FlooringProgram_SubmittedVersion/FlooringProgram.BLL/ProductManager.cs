...
namespace FlooringProgram.BLL
{
    public class ProductManager
    {
        ...
        public decimal GetCostPerSquareFoot(string product)
        {
            ...
            var cost = allProducts.First(c => c.ProductType.Equals(product, StringComparison.CurrentCultureIgnoreCase));
        ...
        {
            var allProducts = _myProductInformationRepository.ListAll();
            var cost = allProducts.First(c => c.ProductType.Equals(productType, StringComparison.CurrentCultureIgnoreCase));
        ...
        public bool IsValidProduct(string product)
        {
            ...
            return allProducts.Any(p => p.ProductType.Equals(product, StringComparison.CurrentCultureIgnoreCase));
        }
    }
}
